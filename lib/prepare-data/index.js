...
async function doImport({banSourcePattern, banoSourcePattern, cadastreSourcePattern, departements, addokFilePattern}) {
  if (departements.length > 1) {
    throw new Error('Désolé. L’opération ne supporte actuellement qu’un département à la fois.')
  }
