...
const {max, union, pick, mapValues, first, groupBy} = require('lodash')
...
function getBestEntry(sources) {
  return sources.ban || sources.ftth || sources.cadastre || sources.bano
}
...
async function prepareData({departement, banPath, banoPath, cadastrePath, ftthPath, addokFilePath}) {
