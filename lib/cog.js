...
function getCodeDepartementByCodeCommune(codeCommune) {
  const isOutremer = codeCommune.startsWith('97') || codeCommune.startsWith('98')
  return isOutremer ? codeCommune.slice(0, 3) : codeCommune.slice(0, 2)
}

module.exports = {getDepartementByCommune, getCommune, getCommunes, getDepartement, getCodeDepartementByCodeCommune}
